...
export abstract class IMutation {
  abstract acheterQtProduit(
    user: string,
    id: number,
    quantite: number,
  ): Nullable<Product> | Promise<Nullable<Product>>;

  abstract lancerProductionProduit(
    user: string,
    id: number,
  ): Nullable<Product> | Promise<Nullable<Product>>;

  abstract engagerManager(
    user: string,
    name: string,
  ): Nullable<Palier> | Promise<Nullable<Palier>>;

  abstract acheterCashUpgrade(
    user: string,
    name: string,
  ): Nullable<Palier> | Promise<Nullable<Palier>>;

  abstract acheterAngelUpgrade(
    user: string,
    name: string,
  ): Nullable<Palier> | Promise<Nullable<Palier>>;
